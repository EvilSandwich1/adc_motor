...
void render::create_controls()
{
    ...
    if (this->m_hWndButton = CreateWindowEx(0, L"BUTTON", L"КАДР", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 0, 100, 300, 30, this->m_hWnd, reinterpret_cast<HMENU>(render::CTL_ID::PLACEHOLDER), nullptr, nullptr); !this->m_hWndButton)
